...
function noRosterWarning () {
    showAlert('No rosters',"You don't appear to have selected rosters. If you have no rosters, then it would appear you don't have doctopus set up. This add-on is meant to be an enhancement for existing <a href='https://chrome.google.com/webstore/detail/doctopus/ffhegaddkjpkfiemhhnphmnadfbkdhbf?hl=en'>Doctopus</a> users.<br><br><small>If you have a list of folder IDs you would like to move, you can still use this Add-On to do so by setting up Column D with the IDs of the folders you want to be children and Column E with IDs of the folders you want to be parents.</small>");
}
